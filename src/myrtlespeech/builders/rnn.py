...
def build(
    ...
    """Returns a :py:class:`myrtlespeech.model.encoder.rnn.RNN` based on cfg.
    ...
    Example:
        ...
        (RNN(
          (rnn): Sequential(
            (0): LSTM(512, 1024, bidirectional=True)
            (1): LSTM(2048, 1024, bidirectional=True)
            (2): LSTM(2048, 1024, bidirectional=True)
            (3): LSTM(2048, 1024, bidirectional=True)
            (4): LSTM(2048, 1024, bidirectional=True)
          )
        ), 2048)
    """
    rnn_type_map = {

...
# ==============================================================================
# Modified by Myrtle Software Ltd to merge files and remove all but required functionality
# ==============================================================================
import random
...
def solve_interpolation(
    ...
    matrix_a = phi(cross_squared_distance_matrix(c, c), order).unsqueeze(
        0
    )  # [b, n, n]
